...
if($_POST["sbutton"] !=NULL)
{
 ...
 $result=mysql_query("select id, AES_DECRYPT(password,'6p1ar3R^w|q6JD{qirL6i5}1O7hq4}') as password , username from login",$con)or die('Could not decrypt: ' . mysql_error());
